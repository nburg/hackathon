 ...
 */
export function tagText(text, config = {}) {
    const doc = nlp(text);
    const results = [];
 ...
 */
export function detectMultiWordExpressions(text) {
    const doc = nlp(text);
    const multiWords = [];
 ...
 */
export function isWithinMultiWord(offset, multiWords) {
 ...
 */
export function filterContentWords(taggedWords) {
