 ...
 */
export function shouldSkipElement(element, config = {}) {
 ...
 */
export function extractTextNodes(root = document, config = {}) {
    const textNodes = [];
 ...
 */
export function extractContentText(root = document, config = {}) {
